"""
Real-time visualization system with camera overlay
Low-latency display using OpenCV with optimized rendering
"""
import cv2
import numpy as np
...
class Visualizer:
    ...
    def render(self):
        ...
        with self.lock:
            ...
            # Add legend inside system panel (moved up)
            legend_y = y_offset + 125 + len(self.info_text) * 35 + 30
